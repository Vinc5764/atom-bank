  ...
  return (
    <div className="s:mt-[3rem] m:mt-[20rem] m:mx-8 mt-20" id="Features">
      <div className="flex flex-col items-center justify-between gap-5 px-4 py-24 md:flex-row-reverse lg:px-12">
        <div className="s:pt-[1rem] flex w-full md:relative md:mb-[28rem] md:w-1/2">
          <img
            className="s:hidden m:hidden inset-0 md:absolute md:z-[1] md:w-[51rem]"
            src={Image}
            alt={`Image of the desktop app`}
          />
          <img
            className="s:w-[23rem] m:mt-[-15rem] s:ml-[6rem] m:ml-[6rem] m:w-[25rem] inset-0 md:absolute md:z-[2] md:w-[18rem] md:shrink"
            src={Phone}
